...
def rmsprop(w, dw, config=None):
  ...
  # ================================================================ #
  a, beta, nu, lr = config['a'], config['decay_rate'], config['epsilon'], config['learning_rate']
  
  a = beta*a + (1-beta)*dw**2
  next_w = w - lr/(np.sqrt(a) + nu) * dw
  config['a'] = a
...
def adam(w, dw, config=None):
  ...
  lr, beta1, beta2 = config['learning_rate'], config['beta1'], config['beta2']
    
  nu, v, a, t = config['epsilon'], config['v'], config['a'], config['t']
